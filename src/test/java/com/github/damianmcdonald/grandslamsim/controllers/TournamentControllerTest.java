...
public class TournamentControllerTest {
	  ...
	  @Test
	  public void getTournamentDetailsSuccessTest() throws Exception {
		  setAuthenticationAuthorizedUser();
		  this.mockMvc.perform(get("/simulator/details/Wimbledon"))
	              .andExpect(status().isOk())
	              .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
	              .andDo(print())
	              .andExpect(jsonPath("$.name", Matchers.equalTo("Wimbledon")));
	  }
	  
	  @Test
	  public void startTournmentSuccessTest() throws Exception {
		  setAuthenticationAuthorizedUser();
		  this.mockMvc.perform(post("/simulator/start/Wimbledon"))
	              .andExpect(status().isOk());
	  }
